...
ENGLISH = [
    ...
    ("licao-2-perguntas-artigos.html", "Lição 3 — Perguntas e Artigos"),
    ("licao-3-revisao-perguntas.html", "Lição 4 — Revisão Perguntas"),
    ("licao-4-preposicoes.html", "Lição 5 — Preposições"),
    ("licao-5-posse.html", "Lição 6 — Posse"),
    ("licao-12-simple-present-daily-life.html", "Lição 7 — Simple Present"),
    ("licao-10-do-does-to-for.html", "Lição 8 — Do/Does · To/For"),
    ("licao-13-perguntas-simple-present.html", "Lição 9 — Perguntas Simple Present"),
    ("licao-15-can-cant.html", "Lição 10 — Can / Can't"),
    ("licao-14-there-is-there-are.html", "Lição 11 — There Is/Are"),
    ("licao-6-here-there.html", "Lição 12 — Here & There"),
    ("licao-8-to-be-passado.html", "Lição 13 — Was/Were"),
    ("licao-21-simple-past-regular.html", "Lição 14 — Simple Past Regular"),
    ("licao-22-simple-past-irregular.html", "Lição 15 — Simple Past Irregular"),
    ("licao-24-future-going-to.html", "Lição 16 — Going To"),
    ("licao-25-future-will.html", "Lição 17 — Will"),
    ("licao-9-revisao-completa.html", "Lição 18 — Revisão A1"),
    ("licao-11-object-possessive-pronouns.html", "Lição 19 — Pronomes Objeto"),
    ("licao-16-present-continuous.html", "Lição 20 — Present Continuous"),
    ("licao-17-countable-uncountable.html", "Lição 21 — Contáveis/Incontáveis"),
    ("licao-18-quantities-choices.html", "Lição 22 — Quantidades"),
    ("licao-19-quantities-distance-time.html", "Lição 23 — Distância e Tempo"),
    ("licao-20-survival-english.html", "Lição 24 — Survival English"),
    ("licao-23-talking-about-the-past.html", "Lição 25 — Falando do Passado"),
    ("licao-26-comparatives-superlatives.html", "Lição 26 — Comparativos"),
    ("licao-28-modal-verbs.html", "Lição 27 — Verbos Modais"),
    ("licao-29-phrasal-verbs.html", "Lição 28 — Phrasal Verbs"),
    ("licao-30-revisao-semestre-2.html", "Lição 29 — Revisão Semestre 2"),
    ("licao-31-past-continuous.html", "Lição 30 — Past Continuous"),
    ("licao-32-simple-past-past-continuous.html", "Lição 31 — Past × Continuous"),
    ("licao-27-present-perfect.html", "Lição 32 — Present Perfect"),
