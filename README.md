...
Esquema oficial do curso: **5 semestres**, com **C1 e C2 unidos no Semestre 5**.

| Semestre | Nível CEFR | Faixa de lições | Status |
|----------|------------|-----------------|--------|
| **1** | A1 (+ Introdutório) | Pronúncia + Lições 1–9 | ✅ Existente no app |
| **2** | A2 | Lições 10–30 | ✅ Existente no app |
| **3** | B1 | Lições 31–40 | ✅ Existente no app |
| **4** | B1 → B2 | Lições 41–50 | 📝 Planejado (roadmap) |
| **5** | B2 → C2 *(C1 + C2)* | Lições 51–70 | 📝 Planejado (roadmap) |

---

### Semestre 1 — A1 (Introdutório + fundamentos)

| # | ID | Nome | Qtd. questões | Descrição |
|---|-----|------|---------------|-----------|
...
| 1 | `verb-to-be` | Verb To Be | 21 | am, is, are — afirmativas, negativas e perguntas |
| 1b | `saudacoes-apresentacoes` | Saudações e Apresentações | 17 | Greetings, introductions e diálogos com áudio |
| 2 | `licao-2-perguntas-artigos` | Lição 2 — Fazendo Perguntas e Apresentando Coisas | 20 | Wh- words, artigos a/an/the — design interativo (jogos, áudio, cartões) |
| 3 | `licao-3-revisao-perguntas` | Lição 3 — Revisando e Praticando: Quem é Você? O Que é Isso? | 12 | Revisão das lições 1 e 2 com prática de diálogos |
| 4 | `licao-4-preposicoes` | Lição 4 — Preposições em Ação: Onde? Com Quem? Como? | 10 | Preposições: onde, com quem e como |
| 5 | `licao-5-posse` | Lição 5 — O Que É Isso? De Quem É? | 12 | O que é isso e de quem é: posse em inglês |
| 6 | `licao-6-here-there` | Lição 6 — Aqui e Ali: Localização e Posição | 12 | Localização, posição e phrasal verbs básicos |
| 8 | `licao-8-to-be-passado` | Lição 8 — Verbo To Be no Passado: Como Era e Onde Estava? | 12 | O verbo to be no passado: was e were |
| 9 | `licao-9-revisao-completa` | Lição 9 — Revisão Completa: Tudo que Aprendemos Até Aqui! | 16 | Revisão completa das lições anteriores |

### Semestre 2 — A2

| # | ID | Nome | Qtd. questões | Descrição |
|---|-----|------|---------------|-----------|
| 10 | `licao-10-do-does-to-for` | Lição 10 — Verbos Essenciais, Perguntas com DO/DOES, e o Uso de TO e FOR | 14 | Verbos essenciais, DO/DOES, TO e FOR |
| 11 | `licao-11-object-possessive-pronouns` | Lesson 11 — People, Objects and Possession | 12 | Pronomes objetos, possessivos e mais de 20 verbos |
| 12 | `licao-12-simple-present-daily-life` | Lição 12 — Simple Present: Rotina e Hábitos Diários | 12 | Simple Present, advérbios de frequência e a rotina diária |
| 13 | `licao-13-perguntas-simple-present` | Lição 13 — Perguntas Naturais no Simple Present | 12 | Perguntas e negativas com Do/Does no Simple Present |
| 14 | `licao-14-there-is-there-are` | Lição 14 — There Is / There Are | 12 | Descrevendo lugares e objetos com There is/There are |
| 15 | `licao-15-can-cant` | Lição 15 — Can, Can't e Comunicação do Dia a Dia | 38 | Teoria completa, diálogo, cultura, vocabulário e exercícios sobre Can/Can't |
| 16 | `licao-16-present-continuous` | Lição 16 — Present Continuous | 12 | Ações em andamento com o Present Continuous |
| 17 | `licao-17-countable-uncountable` | Lição 17 — Substantivos Contáveis e Incontáveis | 12 | Countable/uncountable nouns, some, any e much/many |
| 18 | `licao-18-quantities-choices` | Lição 18 — Quantidades e Escolhas | 12 | Expressando quantidades e fazendo escolhas em inglês |
| 19 | `licao-19-quantities-distance-time` | Lição 19 — Perguntando Sobre Quantidade, Distância e Tempo | 12 | How much/how many, distância e tempo |
| 20 | `licao-20-survival-english` | Lição 20 — Survival English 🌍 | 12 | Frases essenciais para se virar em situações reais |
| 21 | `licao-21-simple-past-regular` | Lição 21 — Simple Past: Verbos Regulares | 12 | Formação e uso do Simple Past com verbos regulares |
| 22 | `licao-22-simple-past-irregular` | Lição 22 — Simple Past: Verbos Irregulares | 12 | Verbos irregulares mais comuns no Simple Past |
| 23 | `licao-23-talking-about-the-past` | Lição 23 — Falando Sobre o Passado | 12 | Perguntas, negativas e expressões de tempo no passado |
| 24 | `licao-24-future-going-to` | Lição 24 — Futuro com Going To | 12 | Planos e intenções futuras com Going To |
| 25 | `licao-25-future-will` | Lição 25 — Futuro com Will | 12 | Previsões, decisões espontâneas e promessas com Will |
| 26 | `licao-26-comparatives-superlatives` | Lição 26 — Comparativos e Superlativos | 12 | Comparando pessoas e coisas em inglês |
| 27 | `licao-27-present-perfect` | Lição 27 — Present Perfect (Introdução) | 12 | Introdução ao Present Perfect: have/has + particípio |
| 28 | `licao-28-modal-verbs` | Lição 28 — Verbos Modais | 12 | Can, could, must, should e outros verbos modais |
| 29 | `licao-29-phrasal-verbs` | Lição 29 — Phrasal Verbs Essenciais | 12 | Phrasal verbs mais usados no inglês do dia a dia |
| 30 | `licao-30-revisao-semestre-2` | Lição 30 — Revisão Geral do Semestre 2 🎓 | 12 | Revisão completa de todo o conteúdo do Semestre 2 |

### Semestre 3 — B1

| # | ID | Nome | Qtd. questões | Descrição |
|---|-----|------|---------------|-----------|
| 31 | `licao-31-past-continuous` | Lição 31 — Past Continuous | 12 | Ações em progresso no passado: was/were + verbo-ing |
| 32 | `licao-32-simple-past-past-continuous` | Lição 32 — Simple Past × Past Continuous | 12 | Combinando ações simultâneas e interrompidas ao contar histórias |
| 33 | `licao-33-present-perfect-experiences` | Lição 33 — Present Perfect: Experiences | 12 | Falando sobre experiências de vida com ever, never, before |
| 34 | `licao-34-present-perfect-simple-past` | Lição 34 — Present Perfect × Simple Past | 12 | Quando usar cada tempo verbal: since, for, last, ago |
| 35 | `licao-35-present-perfect-already-yet-just` | Lição 35 — Present Perfect: Already, Yet, Just | 12 | Already, yet, just, still, recently e lately em contexto |
| 36 | `licao-36-future-will-going-to` | Lição 36 — Future: Will, Going to & Present Continuous | 12 | Decisões espontâneas, planos e compromissos marcados |
| 37 | `licao-37-modal-verbs-advice-obligation` | Lição 37 — Modal Verbs: Advice, Obligation & Permission | 12 | Should, must, have to, can, may e might em contexto real |
| 38 | `licao-38-comparatives-superlatives-equality` | Lição 38 — Comparatives, Superlatives & Equality | 12 | Comparando pessoas e coisas: bigger, the best, as...as |
| 39 | `licao-39-conditionals-zero-first` | Lição 39 — Conditionals: Zero & First Conditional | 12 | Fatos gerais e possibilidades reais no futuro com if/unless |
| 40 | `licao-40-revisao-semestre-3` | Lição 40 — Grande Revisão A2 → B1 🎓 | 12 | Revisão completa do Semestre 3 e projeto final |

### Semestre 4 — B1 → B2 *(planejado)*

**Projeto final:** *The Story of My Life* — narrativa complexa com tempos do passado, hipóteses, voz passiva, discurso indireto e relative clauses.
...
**Projetos:** *An Issue Worth Discussing* (revisão B2→C1) e *The Big Argument* (projeto final C1→C2 / clímax).
...
> **Legenda**
> - ✅ = página HTML em `lessons/` e entrada em `app.js` (já disponível para o aluno)
> - 📝 = apenas no roadmap de `teacher.html` (aba **Próximos Semestres**); ainda precisa ser criada como página
>
> O Semestre 5 junta o antigo conteúdo de C1 e C2 num único bloco, alinhado ao esquema original de 5 semestres.
